...
RSpec.describe "/api/cmor-cms/pages", type: :request do
  ...
  describe "GET index" do
    ...
    before(:each) do
      @collection = create_list(:cmor_cms_page, 3)
    ...
    describe "when authenticated" do
      ...
      describe "data" do
        ...
        it { expect(subject.first["attributes"].keys).to match_array(%w[basename body created_at format handler layout locale meta_description pathname published_at title updated_at]) }
      end
    end
  end
end
