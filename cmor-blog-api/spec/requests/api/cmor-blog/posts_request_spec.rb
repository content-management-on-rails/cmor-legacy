...
RSpec.describe "/api/cmor-blog/posts", type: :request do
  ...
  describe "GET index" do
    ...
    before(:each) do
      @collection = create_list(:cmor_blog_post, 3)
    ...
    describe "when authenticated" do
      ...
      describe "data" do
        ...
        it { expect(subject.first["attributes"].keys).to match_array(%w[body created_at created_by_id locale position published_at slug title updated_at updated_by_id]) }
      end
    end
  end
end
