...
RSpec.describe "/api/cmor-carousels/item_details", type: :request do
  ...
  describe "GET index" do
    ...
    before(:each) do
      @collection = create_list(:cmor_carousels_item_detail, 3)
    ...
    describe "when authenticated" do
      ...
      describe "data" do
        ...
        it { expect(subject.first["attributes"].keys).to match_array(%w[asset_id carousel_id created_at description position published_at updated_at url]) }
      end
    end
  end
end
