...
RSpec.describe "/api/cmor-files/file_details", type: :request do
  ...
  describe "GET index" do
    ...
    before(:each) do
      @collection = create_list(:cmor_files_file_detail, 3)
    ...
    describe "when authenticated" do
      ...
      describe "data" do
        ...
        it { expect(subject.first["attributes"].keys).to match_array(%w[asset_id created_at description folder_id identifier position published_at slug title updated_at]) }
      end
    end
  end
end
