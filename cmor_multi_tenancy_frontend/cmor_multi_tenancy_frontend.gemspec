...
Gem::Specification.new do |spec|
  spec.name        = "cmor_multi_tenancy_frontend"
  spec.version     = Cmor::MultiTenancy::Frontend::VERSION
  ...
  spec.summary     = "Cmor::MultiTenancy::Frontend Module."
  spec.license     = "MIT"
  ...
  spec.add_dependency "cmor_core_frontend", "= 0.0.53.pre"
  spec.add_dependency "cmor_multi_tenancy", "= 0.0.53.pre"
