...
feature 'Cmor::Cms::ContentBox admin' do
  ...
  def set_resource_path
    @resource_path = 'cmor_cms_content_boxes'
  end

  def set_resource_class
    @resource_class = Cmor::Cms::ContentBox
  end
  ...
  def fill_new_form
    fill_in 'cmor_cms_content_box[name]', with: 'Example content box'
  end

  def fill_edit_form
    fill_in 'cmor_cms_content_box[name]', with: 'Updated content box'
  end
