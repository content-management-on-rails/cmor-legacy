...
feature 'Cmor::Cms::Navigation admin' do
  ...
  def set_resource_path
    @resource_path = 'cmor_cms_navigations'
  end

  def set_resource_class
    @resource_class = Cmor::Cms::Navigation
  end
  ...
  def fill_new_form
    select I18n.locale.to_s, from: 'cmor_cms_navigation[locale]'
    fill_in 'cmor_cms_navigation[name]', with: 'Example navigation'
  end

  def fill_edit_form
    fill_in 'cmor_cms_navigation[name]', with: 'New navigation title'
  end
