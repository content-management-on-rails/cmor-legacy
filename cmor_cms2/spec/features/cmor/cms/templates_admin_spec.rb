...
feature 'Cmor::Cms::Template admin' do
  ...
  def set_resource_path
    @resource_path = 'cmor_cms_templates'
  end

  def set_resource_class
    @resource_class = Cmor::Cms::Template
  end
  ...
  def fill_new_form
    fill_in 'cmor_cms_template[pathname]', with: '/'
    fill_in 'cmor_cms_template[basename]', with: '_example_template'
    select 'erb', from: 'cmor_cms_template[handler]'
  end

  def fill_edit_form
    fill_in 'cmor_cms_template[basename]', with: '_changed_template_partial'
  end
