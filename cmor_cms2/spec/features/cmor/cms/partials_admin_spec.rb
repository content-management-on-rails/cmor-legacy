...
feature 'Cmor::Cms::Partial admin' do
  ...
  def set_resource_path
    @resource_path = 'cmor_cms_partials'
  end

  def set_resource_class
    @resource_class = Cmor::Cms::Partial
  end
  ...
  def fill_new_form
    fill_in 'cmor_cms_partial[pathname]', with: '/'
    fill_in 'cmor_cms_partial[basename]', with: '_example_partial'
    select 'erb', from: 'cmor_cms_partial[handler]'
  end

  def fill_edit_form
    fill_in 'cmor_cms_partial[basename]', with: '_changed_basename_partial'
  end
