Cmor::Showcase::Frontend.configure do |config|
  ...
  #
  # Default: config.default_render_items_variant_options = { resize: "768x432^", gravity: :center, extent: "768x432" }
  #
  config.default_render_items_variant_options = { resize: "768x432^", gravity: :center, extent: "768x432" }
