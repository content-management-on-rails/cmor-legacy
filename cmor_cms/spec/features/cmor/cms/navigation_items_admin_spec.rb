...
feature 'Cmor::Cms::NavigationItem admin' do
  ...
  def set_resource_path
    @resource_path = 'cmor_cms_navigation_items'
  end

  def set_resource_class
    @resource_class = Cmor::Cms::NavigationItem
  end
  ...
  def prepare_for_new
    @navigation = FactoryBot.create(:cmor_cms_navigation)
  end

  def fill_new_form
    select @navigation.to_s, from: 'cmor_cms_navigation_item[cmor_cms_navigation_id]'
    fill_in 'cmor_cms_navigation_item[name]', with: 'About us'
    fill_in 'cmor_cms_navigation_item[url]', with: '/about-us'
    fill_in 'cmor_cms_navigation_item[key]', with: 'about_us'
  end

  def fill_edit_form
    fill_in 'cmor_cms_navigation_item[name]', with: 'About'
  end
