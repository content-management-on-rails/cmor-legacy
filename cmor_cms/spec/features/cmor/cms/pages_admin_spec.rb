...
feature 'Cmor::Cms::Page admin' do
  ...
  def set_resource_path
    @resource_path = 'cmor_cms_pages'
  end

  def set_resource_class
    @resource_class = Cmor::Cms::Page
  end
  ...
  def fill_new_form
    fill_in 'cmor_cms_page[title]', with: 'About us'
    fill_in 'cmor_cms_page[pathname]', with: '/'
    fill_in 'cmor_cms_page[basename]', with: 'about_us'
    select 'erb', from: 'cmor_cms_page[handler]'
  end

  def fill_edit_form
    fill_in 'cmor_cms_page[title]', with: 'About'
  end
