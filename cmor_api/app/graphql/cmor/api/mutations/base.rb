  ...
  module Api
    module Mutations
      class Base < GraphQL::Schema::Mutation
        ...
        #     boolean: Cmor::Api::Backend::Mutations::Base::Boolean
        #   }

        #   class_methods do
        #     def infer_fields_from_resource_class!(always_allow_null: false)
