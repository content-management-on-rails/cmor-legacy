...
RSpec.describe Cmor::Blog::Post, type: :model do
  ...
  describe 'asset_details' do
    ...
    describe '#appending assets' do
      ...
      it { expect{ subject.append_asset_detail_assets = new_asset_detail_assets; subject.save }.to change { Cmor::Blog::AssetDetail.count }.from(2).to(3) }
    end
    ...
    describe '#overwriting assets' do
      ...
      it { expect{ subject.overwrite_asset_detail_assets = new_asset_detail_assets; subject.save }.to change { Cmor::Blog::AssetDetail.count }.from(2).to(1) }
    end
  end
end
