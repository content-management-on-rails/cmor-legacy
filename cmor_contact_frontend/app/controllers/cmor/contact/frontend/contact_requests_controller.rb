module Cmor
  module Contact
    module Frontend
      class ContactRequestsController < Cmor::Contact::Frontend::Configuration.base_controller.constantize
        ...
        def after_create_url
          Cmor::Contact::Frontend::Configuration.after_create_url.call(self)
        end
      end
    end
  end
